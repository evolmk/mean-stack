angular.module('mainCtrl', ['appServices'])
    ...
    .controller('mainController', function ($scope, alertService) {
    ...
    .controller('playersController', function ($scope, alertService) {
        // bind this to vm (view-model)
        var vm = this;
        ...
        vm.addPlayer = function () {
            ...
            alertService.add("success", "Player Addedd Successfully");
